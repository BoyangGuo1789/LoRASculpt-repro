...
class ModelArguments:
    ...
    trainer_name: str = field(default="Normal") # Trainer Name
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        ...
        model.config.trainer_name = training_args.trainer_name = model_args.trainer_name
    ...
    from llava.train import get_trainer
    trainer = get_trainer(name=model_args.trainer_name,
                            model=model,
                            tokenizer=tokenizer,
